...
from .views import (CriteriaViewSet, ProjectCreateView, ProjectDeleteView,
                    ProjectDetailView, ProjectsOutputView, ProjectUpdateView,
                    ProjectViewSet, UserProjectsOutputView, add_responsible,
                    change_criteria)
...
urlpatterns = [
    ...
    path(
        "projects/create/", ProjectCreateView.as_view(), name="project_create_url"
    ),
    path(
        "my_projects/",
